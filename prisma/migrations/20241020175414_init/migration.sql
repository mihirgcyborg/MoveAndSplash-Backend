...
CREATE TABLE `Place` (
    ...
    `descriptionShort` VARCHAR(191) NOT NULL,
    `descriptionLong` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Amenity` ADD CONSTRAINT `Amenity_placeId_fkey` FOREIGN KEY (`placeId`) REFERENCES `Place`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
